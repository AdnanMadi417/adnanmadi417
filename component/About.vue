...
.info-box {
  background: #f8f9fa;
  padding: 2.5rem;
  border-left: 5px solid #2E4E43FF;
}
...
.story-card {
  ...
  background: #f8f9fa;
  border-radius: 0;
  border-left: 4px solid #2E4E43FF;
  transition: all 0.3s ease;
}

.story-card:hover {
  transform: translateX(8px);
  box-shadow: -8px 8px 0 #2E4E43FF;
}
